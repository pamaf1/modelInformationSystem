...
public static PetriNet CreateShopFridge() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay{
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	d_P.add(new PetriP("Client",0));
	d_P.add(new PetriP("Sold",0));
	d_P.add(new PetriP("PreGoneDecision",0));
	d_P.add(new PetriP("Gone",0));
	d_P.add(new PetriP("Fridges",72));
	d_P.add(new PetriP("Order",1));

	d_T.add(new PetriT("SellFridge",0));
	d_T.add(new PetriT("OrderNew",3));
	d_T.add(new PetriT("DontSell",0));
	d_T.add(new PetriT("WaiForFridge",0));
	d_T.add(new PetriT("GoToAnotherStore",0));
	d_T.add(new PetriT("PreGone",0));
