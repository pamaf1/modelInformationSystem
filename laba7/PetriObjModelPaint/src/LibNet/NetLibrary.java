...
public static PetriNet robotTakingAction(int numChannel, double timeMean, String name) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay{
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	d_P.add(new PetriP("Parts",0));
	d_P.add(new PetriP("Robot",numChannel));
	d_P.add(new PetriP("P3",0));
	d_T.add(new PetriT("T1",timeMean));
	d_T.get(0).setPriority(2);
	d_T.get(0).setDistribution("unif", 8);
	d_T.get(0).setParamDeviation(1.0);

	d_In.add(new ArcIn(d_P.get(0),d_T.get(0),1));
	d_In.add(new ArcIn(d_P.get(1),d_T.get(0),1));
	d_Out.add(new ArcOut(d_T.get(0),d_P.get(2),1));
	PetriNet d_Net = new PetriNet("Take"+name,d_P,d_T,d_In,d_Out);
	PetriP.initNext();
	PetriT.initNext();
	ArcIn.initNext();
	ArcOut.initNext();
...
public static PetriNet robotPutAction(int numChannel, double timeMean, String name) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay{
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	...
	d_Out.add(new ArcOut(d_T.get(0),d_P.get(1),1));
	d_Out.add(new ArcOut(d_T.get(0),d_P.get(2),1));
	PetriNet d_Net = new PetriNet("Put"+name,d_P,d_T,d_In,d_Out);
	PetriP.initNext();
	PetriT.initNext();
	ArcIn.initNext();
	ArcOut.initNext();
...
public static PetriNet robotTransportingAction(int numChannel, double timeMean, String name) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay{
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	...
	d_T.add(new PetriT("T1",timeMean));
	d_T.get(0).setDistribution("unif", timeMean);
	d_T.get(0).setParamDeviation(0.0);
	d_In.add(new ArcIn(d_P.get(0),d_T.get(0),1));
	d_Out.add(new ArcOut(d_T.get(0),d_P.get(1),1));
	PetriNet d_Net = new PetriNet("Transport"+name,d_P,d_T,d_In,d_Out);
	PetriP.initNext();
	PetriT.initNext();
	ArcIn.initNext();
	ArcOut.initNext();
...
public static PetriNet robotTransportingBackAction(int numChannel, double timeMean, String name) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay{
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	...
	d_T.add(new PetriT("T2",0));
	d_In.add(new ArcIn(d_P.get(0),d_T.get(0),1));
	d_Out.add(new ArcOut(d_T.get(0),d_P.get(1),1));
	PetriNet d_Net = new PetriNet("Transport Back"+name,d_P,d_T,d_In,d_Out);
	PetriP.initNext();
	PetriT.initNext();
	ArcIn.initNext();
	ArcOut.initNext();
...
public static PetriNet firstStation(double timeMean) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay{
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	...
	d_Out.add(new ArcOut(d_T.get(0),d_P.get(1),1));
	d_Out.add(new ArcOut(d_T.get(0),d_P.get(2),1));
	PetriNet d_Net = new PetriNet("First Station",d_P,d_T,d_In,d_Out);
	PetriP.initNext();
	PetriT.initNext();
	ArcIn.initNext();
	ArcOut.initNext();
...
public static PetriNet secondStation(double timeMean) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay{
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	...
	d_In.add(new ArcIn(d_P.get(0),d_T.get(0),1));
	d_Out.add(new ArcOut(d_T.get(0),d_P.get(1),1));
	PetriNet d_Net = new PetriNet("Second Station",d_P,d_T,d_In,d_Out);
	PetriP.initNext();
	PetriT.initNext();
	ArcIn.initNext();
	ArcOut.initNext();
...
public static PetriNet busStationCreation(int numChannel, int passangersNeeded) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay{
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	d_P.add(new PetriP("Passangers",0));
	d_P.add(new PetriP("Bus A",1));
	d_P.add(new PetriP("Bus B",1));
	d_P.add(new PetriP("Bus A arrival",0));
	d_P.add(new PetriP("Bus B arrival",0));
	d_P.add(new PetriP("Passangers A Out",0));
	d_P.add(new PetriP("Passangers B Out",0));
	d_P.add(new PetriP("A Ride Back",0));
	d_P.add(new PetriP("B Ride Back",0));

	d_T.add(new PetriT("Bus A Ride", -1));
	d_T.add(new PetriT("Bus B Ride", -1));
	d_T.add(new PetriT("Bus A Ride Back", -1));
	d_T.add(new PetriT("Bus B Ride Back", -1));
	d_T.add(new PetriT("Bus A Out", -1));
	d_T.add(new PetriT("Bus B Out", -1));

	d_T.get(0).setPriority(2);
	d_T.get(0).setDistribution("unif", 20);
	d_T.get(0).setParamDeviation(5);
	d_T.get(1).setDistribution("unif", 30);
	d_T.get(1).setParamDeviation(5);
	d_T.get(4).setDistribution("unif", 5);
	d_T.get(4).setParamDeviation(1);
	d_T.get(5).setDistribution("unif", 5);
	d_T.get(5).setParamDeviation(1);
	d_T.get(2).setDistribution("unif", 20);
	d_T.get(2).setParamDeviation(5);
	d_T.get(3).setDistribution("unif", 30);
	d_T.get(3).setParamDeviation(5);

	d_In.add(new ArcIn(d_P.get(0),d_T.get(0),passangersNeeded));
	d_In.add(new ArcIn(d_P.get(0),d_T.get(1),passangersNeeded));
 ...
 /**
     ...
     * @throws PetriObj.ExceptionInvalidNetStructure
     */
public static PetriNet CreateNetGenerator(double timeMean, int outK, String distr) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	...
	d_T.get(0).setDistribution(distr, d_T.get(0).getTimeServ());
	d_T.get(0).setParamDeviation(0.0);
	d_In.add(new ArcIn(d_P.get(0),d_T.get(0),1));
	d_Out.add(new ArcOut(d_T.get(0),d_P.get(1),outK));
